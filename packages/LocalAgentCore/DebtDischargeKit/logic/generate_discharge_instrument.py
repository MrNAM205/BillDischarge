def generate_discharge_instrument(full_name, statement_id, amount, creditor):
    ...
    I, {full_name}, hereby conditionally accept the claim referenced as {statement_id} 
    for value and proof of claim. I demand verified accounting, lawful money, and full 
