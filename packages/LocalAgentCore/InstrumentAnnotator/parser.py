...
class BillParser:
    ...
    def parse_free_text_bill(self, bill_text: str) -> Dict[str, Any]:
        ...
        end_time = time.time()
        print(f"parse_free_text_bill execution time: {end_time - start_time:.4f} seconds")
        return bill_data
    ...
    def parse_bill(self, bill_text: str) -> Dict[str, Any]:
        ...
        if structured_data.get("bill_number"):
            end_time = time.time()
            print(f"parse_bill execution time: {end_time - start_time:.4f} seconds")
    ...
    def parse_structured_bill(self, bill_text: str) -> Dict[str, Any]:
        ...
        end_time = time.time()
        print(f"parse_structured_bill execution time: {end_time - start_time:.4f} seconds")
        return bill_data
