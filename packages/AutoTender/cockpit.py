...
from autotender import generator, scanner
...
def main(args):
    ...
    if not found_keywords:
        ...
        violation = KEYWORD_TO_VIOLATION.get(
            found_keywords[0]
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(
        description="Sovereign Financial Cockpit: Automate document scanning and remedy generation."
    )
    parser.add_argument(
        "--document", required=True, help="Path to the document to process."
    )
